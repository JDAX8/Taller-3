import { Actions, EditProfileAction, GetUser, ActionNavigation, NavigationActions, ADDUserAction, PostupAction, UserActions,Screens, savePost, ActionLogOut, logInAction, AuthAction, SetCredentialsAction } from "../types/store";
...
export const savePos = (Postt: Postt): savePost => {
  return{
